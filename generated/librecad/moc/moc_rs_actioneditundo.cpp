...
**
** Created: Tue Jun 18 04:08:35 2013
...
static const char qt_meta_stringdata_RS_ActionEditUndo[] = {
    "RS_ActionEditUndo\0"
};
...
const QMetaObjectExtraData RS_ActionEditUndo::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RS_ActionEditUndo::staticMetaObject = {
    { &RS_ActionInterface::staticMetaObject, qt_meta_stringdata_RS_ActionEditUndo,
      qt_meta_data_RS_ActionEditUndo, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RS_ActionEditUndo::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RS_ActionEditUndo))
        return static_cast<void*>(const_cast< RS_ActionEditUndo*>(this));
