...
**
** Created: Tue Jun 18 04:11:57 2013
...
static const char qt_meta_stringdata_LC_Align[] = {
    "LC_Align\0"
};
...
const QMetaObjectExtraData LC_Align::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject LC_Align::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LC_Align,
      qt_meta_data_LC_Align, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &LC_Align::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_LC_Align))
